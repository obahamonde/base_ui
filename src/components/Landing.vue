...
<template>
 <div
    ...
    >
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/obahamondem"
          target="_blank"
    ...
    >
      <h1 class="text-title invert text-4xl">Agile</h1>
    </div>
    <div
    ...
    >
      ...
      >
        ...
        <p class="m-0 max-w-[30ch] text-sm text-accent dark:text-success opacity-50">
          {{ i.description }}
        </p>
      </a>
